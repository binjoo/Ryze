...
public class CopyOfMenuConfig {
    ...
    static {
        ...
        tmpMenuList.add(addSidebarMenu("user_manage", "用户管理", "user"));
        tmpMenuList.add(addSidebarMenu("manage_group", "管理组", "user"));
        tmpMenuList.add(addSidebarMenu("member_group", "会员组", "user"));
